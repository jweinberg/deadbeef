...
struct b2FixtureDef
{
	...
	//A a fixture that can be attracted by magnets
	bool isMagnetic;
...
public:
	...
	/// Is this fixture magnetic?
	/// @return the true if the fixture is affect by magnetic.
	bool IsMagnetic() const;

	void SetIsMagnetic(bool magnetic) { m_isMagnetic = magnetic; };
	...
	void SetPhysicsSprite(Deadbeef::PhysicsSprite & val){m_physicsSprite = &val;}
	Deadbeef::PhysicsSprite * GetPhysicsSprite(){return m_physicsSprite;}
...
protected:
	...
	Deadbeef::PhysicsSprite* m_physicsSprite;
};
...
inline bool b2Fixture::IsMagnetic() const
{
	return m_isMagnetic;
}
